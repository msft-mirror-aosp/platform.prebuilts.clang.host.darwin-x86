...
# Import target "clangScalableStaticAnalysisFrameworkAnalyses" for configuration "Release"
set_property(TARGET clangScalableStaticAnalysisFrameworkAnalyses APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangScalableStaticAnalysisFrameworkAnalyses PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkAnalyses.a"
  )

list(APPEND _cmake_import_check_targets clangScalableStaticAnalysisFrameworkAnalyses )
list(APPEND _cmake_import_check_files_for_clangScalableStaticAnalysisFrameworkAnalyses "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkAnalyses.a" )

# Import target "clangScalableStaticAnalysisFrameworkCore" for configuration "Release"
set_property(TARGET clangScalableStaticAnalysisFrameworkCore APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangScalableStaticAnalysisFrameworkCore PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkCore.a"
  )

list(APPEND _cmake_import_check_targets clangScalableStaticAnalysisFrameworkCore )
list(APPEND _cmake_import_check_files_for_clangScalableStaticAnalysisFrameworkCore "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkCore.a" )

# Import target "clangScalableStaticAnalysisFrameworkFrontend" for configuration "Release"
set_property(TARGET clangScalableStaticAnalysisFrameworkFrontend APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangScalableStaticAnalysisFrameworkFrontend PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkFrontend.a"
  )

list(APPEND _cmake_import_check_targets clangScalableStaticAnalysisFrameworkFrontend )
list(APPEND _cmake_import_check_files_for_clangScalableStaticAnalysisFrameworkFrontend "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkFrontend.a" )

# Import target "clangScalableStaticAnalysisFrameworkTool" for configuration "Release"
set_property(TARGET clangScalableStaticAnalysisFrameworkTool APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangScalableStaticAnalysisFrameworkTool PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkTool.a"
  )

list(APPEND _cmake_import_check_targets clangScalableStaticAnalysisFrameworkTool )
list(APPEND _cmake_import_check_files_for_clangScalableStaticAnalysisFrameworkTool "${_IMPORT_PREFIX}/lib/libclangScalableStaticAnalysisFrameworkTool.a" )
...
# Import target "clangUnifiedSymbolResolution" for configuration "Release"
set_property(TARGET clangUnifiedSymbolResolution APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangUnifiedSymbolResolution PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangUnifiedSymbolResolution.a"
  )

list(APPEND _cmake_import_check_targets clangUnifiedSymbolResolution )
list(APPEND _cmake_import_check_files_for_clangUnifiedSymbolResolution "${_IMPORT_PREFIX}/lib/libclangUnifiedSymbolResolution.a" )
...
list(APPEND _cmake_import_check_files_for_clang "${_IMPORT_PREFIX}/bin/clang-23" )
...
# Import target "clang-ssaf-format" for configuration "Release"
set_property(TARGET clang-ssaf-format APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clang-ssaf-format PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clang-ssaf-format"
  )

list(APPEND _cmake_import_check_targets clang-ssaf-format )
list(APPEND _cmake_import_check_files_for_clang-ssaf-format "${_IMPORT_PREFIX}/bin/clang-ssaf-format" )

# Import target "clang-ssaf-linker" for configuration "Release"
set_property(TARGET clang-ssaf-linker APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clang-ssaf-linker PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clang-ssaf-linker"
  )

list(APPEND _cmake_import_check_targets clang-ssaf-linker )
list(APPEND _cmake_import_check_files_for_clang-ssaf-linker "${_IMPORT_PREFIX}/bin/clang-ssaf-linker" )
...
# Import target "clangTidyCustomModule" for configuration "Release"
set_property(TARGET clangTidyCustomModule APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangTidyCustomModule PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyCustomModule.a"
  )
...
set_target_properties(clangDocSupport PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangDocSupport.a"
  )
...
set_target_properties(ClangdXPCLib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libClangdXPCLib.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libClangdXPCLib.dylib"
  )

list(APPEND _cmake_import_check_targets ClangdXPCLib )
list(APPEND _cmake_import_check_files_for_ClangdXPCLib "${_IMPORT_PREFIX}/lib/libClangdXPCLib.dylib" )
...
set_target_properties(clangd-xpc-test-client PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangd-xpc-test-client"
  )

list(APPEND _cmake_import_check_targets clangd-xpc-test-client )
list(APPEND _cmake_import_check_files_for_clangd-xpc-test-client "${_IMPORT_PREFIX}/bin/clangd-xpc-test-client" )
...
set_target_properties(clangdXpcJsonConversions PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangdXpcJsonConversions.a"
  )

list(APPEND _cmake_import_check_targets clangdXpcJsonConversions )
list(APPEND _cmake_import_check_files_for_clangdXpcJsonConversions "${_IMPORT_PREFIX}/lib/libclangdXpcJsonConversions.a" )
...
set_target_properties(clangdXpcTransport PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libclangdXpcTransport.a"
  )

list(APPEND _cmake_import_check_targets clangdXpcTransport )
list(APPEND _cmake_import_check_files_for_clangdXpcTransport "${_IMPORT_PREFIX}/lib/libclangdXpcTransport.a" )
