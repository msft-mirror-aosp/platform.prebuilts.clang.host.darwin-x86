...
set_target_properties(LLVMSupport PROPERTIES
  INTERFACE_LINK_LIBRARIES "m;ZLIB::ZLIB;zstd::libzstd_static;LLVMDemangle"
)
...
# Create imported target LLVMBOLTCore
add_library(LLVMBOLTCore STATIC IMPORTED)

set_target_properties(LLVMBOLTCore PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMDebugInfoDWARF;LLVMDemangle;LLVMMC;LLVMMCDisassembler;LLVMObject;LLVMSupport;LLVMTargetParser;\$<LINK_ONLY:LLVMBOLTUtils>"
)

# Create imported target LLVMBOLTPasses
add_library(LLVMBOLTPasses STATIC IMPORTED)

set_target_properties(LLVMBOLTPasses PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMAsmPrinter;LLVMMC;LLVMSupport;LLVMTargetParser;LLVMTransformUtils;\$<LINK_ONLY:LLVMBOLTCore>;\$<LINK_ONLY:LLVMBOLTUtils>"
)

# Create imported target LLVMBOLTProfile
add_library(LLVMBOLTProfile STATIC IMPORTED)

set_target_properties(LLVMBOLTProfile PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMSupport;\$<LINK_ONLY:LLVMBOLTCore>;\$<LINK_ONLY:LLVMBOLTPasses>;\$<LINK_ONLY:LLVMBOLTUtils>"
)

# Create imported target LLVMBOLTRewrite
add_library(LLVMBOLTRewrite STATIC IMPORTED)

set_target_properties(LLVMBOLTRewrite PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMDebugInfoDWARF;LLVMDWP;LLVMExecutionEngine;LLVMMC;LLVMObject;LLVMSupport;LLVMTargetParser;\$<LINK_ONLY:LLVMBOLTCore>;\$<LINK_ONLY:LLVMBOLTPasses>;\$<LINK_ONLY:LLVMBOLTProfile>;\$<LINK_ONLY:LLVMBOLTRuntimeLibs>;\$<LINK_ONLY:LLVMBOLTUtils>;\$<LINK_ONLY:LLVMBOLTTargetAArch64>;\$<LINK_ONLY:LLVMBOLTTargetX86>"
)

# Create imported target LLVMBOLTRuntimeLibs
add_library(LLVMBOLTRuntimeLibs STATIC IMPORTED)

set_target_properties(LLVMBOLTRuntimeLibs PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMBinaryFormat;LLVMMC;LLVMObject;LLVMRuntimeDyld;LLVMSupport;\$<LINK_ONLY:LLVMBOLTCore>;\$<LINK_ONLY:LLVMBOLTPasses>;\$<LINK_ONLY:LLVMBOLTUtils>"
)

# Create imported target LLVMBOLTTargetAArch64
add_library(LLVMBOLTTargetAArch64 STATIC IMPORTED)

set_target_properties(LLVMBOLTTargetAArch64 PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMMC;LLVMSupport;LLVMAArch64Desc;\$<LINK_ONLY:LLVMBOLTCore>"
)

# Create imported target LLVMBOLTTargetX86
add_library(LLVMBOLTTargetX86 STATIC IMPORTED)

set_target_properties(LLVMBOLTTargetX86 PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMMC;LLVMMCDisassembler;LLVMSupport;LLVMX86Desc;\$<LINK_ONLY:LLVMBOLTCore>;\$<LINK_ONLY:LLVMBOLTUtils>"
)

# Create imported target LLVMBOLTUtils
add_library(LLVMBOLTUtils STATIC IMPORTED)

set_target_properties(LLVMBOLTUtils PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMSupport"
)

# Create imported target llvm-bolt
add_executable(llvm-bolt IMPORTED)

# Create imported target llvm-bat-dump
add_executable(llvm-bat-dump IMPORTED)

# Create imported target merge-fdata
add_executable(merge-fdata IMPORTED)

# Create imported target llvm-bolt-heatmap
add_executable(llvm-bolt-heatmap IMPORTED)
