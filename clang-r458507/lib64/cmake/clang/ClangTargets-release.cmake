...
set_target_properties(clangAnalysisFlowSensitive PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclangAnalysisFlowSensitive.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangAnalysisFlowSensitive )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangAnalysisFlowSensitive "${_IMPORT_PREFIX}/lib64/libclangAnalysisFlowSensitive.a" )
...
set_target_properties(clangAnalysisFlowSensitiveModels PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclangAnalysisFlowSensitiveModels.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangAnalysisFlowSensitiveModels )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangAnalysisFlowSensitiveModels "${_IMPORT_PREFIX}/lib64/libclangAnalysisFlowSensitiveModels.a" )
...
set_target_properties(clangExtractAPI PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclangExtractAPI.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangExtractAPI )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangExtractAPI "${_IMPORT_PREFIX}/lib64/libclangExtractAPI.a" )
...
set_target_properties(clang-cpp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclang-cpp.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libclang-cpp.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS clang-cpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_clang-cpp "${_IMPORT_PREFIX}/lib64/libclang-cpp.dylib" )
...
set_target_properties(clangPseudo PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclangPseudo.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangPseudo )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangPseudo "${_IMPORT_PREFIX}/lib64/libclangPseudo.a" )
...
set_target_properties(ClangdXPCLib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libClangdXPCLib.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libClangdXPCLib.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS ClangdXPCLib )
list(APPEND _IMPORT_CHECK_FILES_FOR_ClangdXPCLib "${_IMPORT_PREFIX}/lib64/libClangdXPCLib.dylib" )
...
list(APPEND _IMPORT_CHECK_TARGETS clangd-xpc-test-client )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangd-xpc-test-client "${_IMPORT_PREFIX}/bin/clangd-xpc-test-client" )
...
set_target_properties(clangdXpcJsonConversions PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclangdXpcJsonConversions.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangdXpcJsonConversions )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangdXpcJsonConversions "${_IMPORT_PREFIX}/lib64/libclangdXpcJsonConversions.a" )
...
set_target_properties(clangdXpcTransport PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclangdXpcTransport.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangdXpcTransport )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangdXpcTransport "${_IMPORT_PREFIX}/lib64/libclangdXpcTransport.a" )
...
set_target_properties(libclang PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libclang.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libclang.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS libclang )
list(APPEND _IMPORT_CHECK_FILES_FOR_libclang "${_IMPORT_PREFIX}/lib64/libclang.dylib" )
